...
# Introduction 
Squeezing a little more speed out of your code can be extremely important, especially when dealing with Big Data, which is becoming increasing prevalent in the Tech sector. In order to go about making better code, one has to experience code across the the entire spectrum of quality, from the very worst way to accomplish something, to the very best. Unfortunately, it can be difficult for begining programmers to do this, which is why I wrote this article. 
